...
<body class="hold-transition skin-blue sidebar-mini">
	<div class="wrapper">
											...
											<tbody>
												...
												<tr style="text-align: center;">
													...
													<td>
														...
														<a row-id="<?= $lead['lead_id'] ?>" data-toggle="modal" data-target="#myModal1" class="pl-10 pr-10 font-20 follow-up"><i class="fa fa-edit"></i></a>
													</td>
												</tr>
												<?php $n++;} ?>
											</tbody>
			...
			<div class="modal-dialog modal-lg">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Close Leads</h4>
					</div>
		...
		$.ajax({
		url:'<?= base_url('admin/select_doormat/') ?>'+lead_id,
		type:'get',
		cache:false,
		...
		lead_id=$(this).attr('row-id');
		$.ajax({
		url:'<?= base_url('admin/select_doormat_edit/') ?>'+lead_id,
		type:'get',
		cache:false,
