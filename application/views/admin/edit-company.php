				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<div class="box-body">
								<form action="<?= base_url('admin/admin_edit_company/') ?><?= $company->company_id ?>" method="post">
									<div class="form-group">
										...
										<div class="col-xs-6 mb-5">
											...
											<div class="input-group">
												...
												<textarea type="text" placeholder="Company Address" rowspan="1" class="form-control" name="street_address" required><?= $company->address_1 ?></textarea>
											</div>
										</div>
										...
										<div class="col-xs-6 mb-5">
											...
											<div class="input-group">
												...
												<textarea type="text" name="street_address_2" placeholder="Company Address 2" rowspan="1" class="form-control"><?= $company->address_2 ?></textarea>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="postal_code" value="<?= $company->zip ?>" class="form-control" required>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<select class="form-control" name="country">
													<optgroup id="countryofresidence-optgroup-Frequently Used" label="Frequently Used" required>
														<option value="<?= $company->country ?>" label="<?= $company->country ?>" selected="selected"><?= $company->country ?></option>
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="first_name" class="form-control" placeholder="First Name" value="<?= $company->firstname ?>">
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="last_name" class="form-control" placeholder="Last Name" value="<?= $company->lastname ?>">
											</div>
										</div>
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="row">
												<div class="col-md-2">
												<input type="text" name="phone1" placeholder="Country code" class="form-control" value="<?= $company->phone_ext ?>">
											</div>
											<div class="col-md-10">
												<input type="text" name="phone" value="<?= $company->phone_number ?>" placeholder="Number" class="form-control">
											</div>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											...
											<div class="row">
												<div class="col-md-2">
												<input type="text" name="landline1" placeholder="Area code" class="form-control" value="<?= $company->landline_ext ?>">
											</div>
											<div class="col-md-10">
												<input type="text" name="landline" value="<?= $company->landline_number ?>" placeholder="Number" class="form-control">
											</div>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="company_email_address" value="<?= $company->company_email ?>" class="form-control" required>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="email_address" class="form-control" value="<?= $company->login_email ?>" readonly>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="password" name="conpassword" placeholder="Re-enter Password" class="form-control conpassword">
											</div>
										</div>
										<div class="col-sm-12 mt-20">
											<button type="submit" class="btn btn-primary btn-lg">Update Company &nbsp; <i class="fa fa-forward" aria-hidden="true"></i></button>
