				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<div class="box-body">
								<form action="<?= base_url('admin/admin_edit_user/') ?><?= $user->user_id ?>" method="post" enctype="multipart/form-data">
									<div class="form-group">
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" name="company_name" value="<?= $user->company ?>">
											</div>
										</div>
											...
											<div class="input-group">
												...
												<select class="form-control" name="country">
													<optgroup id="countryofresidence-optgroup-Frequently Used" label="Frequently Used" required>
														<option value="<?= $user->country ?>" label="<?= $user->country ?>" selected="selected"><?= $user->country ?></option>
										...
										<div class="col-xs-6 mb-5">
											...
											<div class="input-group">
												...
												<textarea type="text" value="street_address" name="street_address" rowspan="1" class="form-control" required><?= $user->street_address ?></textarea>
											</div>
										</div>

										<div class="col-xs-6 mb-5">
											<label for="address" class="required">Apartment, Suit, Unit Address <span class="reqs"> *</span></label>
											<div class="input-group">
												<div class="input-group-addon">
													<i class="fa fa-suitcase"></i>
												</div>
												<textarea type="text" name="street_address_2" value="<?= $user->street_address_2 ?>" rowspan="1" class="form-control"><?= $user->street_address_2 ?></textarea>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="postal_code" value="<?= $user->zip ?>" class="form-control" required>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											<label for="telephone" class="required">Phone <span class="reqs"> *</span></label>
											<div class="row">
												<div class="col-md-2">
												<input type="text" name="phone1" placeholder="Country code" class="form-control" value="<?= $user->country_code ?>">
											</div>
											<div class="col-md-8">
												<input type="text" name="phone" placeholder="Number" class="form-control" value="<?= $user->phone ?>" >
											</div>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											<label for="telephone" class="required">Landline <span class="reqs"> *</span></label>
											<div class="row">
												<div class="col-md-2">
												<input type="text" name="landline1" value="<?= $user->landline_code ?>" placeholder="Code" class="form-control">
											</div>
											<div class="col-md-8">
												<input type="text" name="landline" value="<?= $user->landline ?>" placeholder="Number" class="form-control">
											</div>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
											...
											<div class="input-group">
												...
												<input type="text" name="email_address" value="<?= $user->email ?>" class="form-control" required>
											</div>
										</div> 
										<div class="col-sm-6 mb-5">
											<label for="profile" class="required">Profile Pic <span class="reqs"> *</span></label>
											...
											<img src="<?= base_url('documents/') ?><?= $user->profile_picture ?>" width="60px"><br/>
										</div>
										<div class="col-sm-6 mb-5">
										...
										<div class="col-sm-12 mt-20">
											<button type="submit" class="btn btn-primary btn-md">Update &nbsp; <i class="fa fa-forward" aria-hidden="true"></i></button>
										</div>
									</div>
								</form>
							</div>
