				...
				<div class="row">
					<div class="col-md-12">
						<div class="box box-primary">
							...
							<!-- /.box-header -->
							<div class="box-body">
								<form action="<?= base_url('admin/admin_add_user') ?>" method="post">
									<div class="form-group">
										<div class="col-sm-6 mb-5">
											<label>User Type <span class="reqs"> Please select carefully</span>:</label>
										...
										<div class="col-xs-6 mb-5">
											...
											<div class="input-group">
												...
												<textarea type="text" placeholder="House No. and Street Name" rowspan="1" class="form-control" name="street_address" required></textarea>
											</div>
										</div>
										...
										<div class="col-xs-6 mb-5">
											...
											<div class="input-group">
												...
												<textarea type="text" name="street_address_2" placeholder="Apartment, Suit, Unit etc." rowspan="1" class="form-control"></textarea>
											</div>
										</div>
										<div class="col-sm-6 mb-5">
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="row">
												<div class="col-md-2">
												<input type="text" name="phone1" placeholder="Country code" class="form-control">
											</div>
											<div class="col-md-8">
										...
										<div class="col-sm-6 mb-5">
											...
											<div class="row">
												<div class="col-md-2">
												<input type="text" name="landline1" placeholder="Area code" class="form-control">
											</div>
											<div class="col-md-8">
										...
										<div class="col-sm-12 mt-20">
											<button type="submit" class="btn btn-primary btn-lg">Create An Account &nbsp; <i class="fa fa-forward" aria-hidden="true"></i></button>
